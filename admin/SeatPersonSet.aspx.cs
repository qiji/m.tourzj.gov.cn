...
public partial class admin_SeatPersonSet : System.Web.UI.Page
{
    public string mid;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            int iwidth = ((width - 470) / (seatx * 1 + 1)) - 3;
            ...
            for (int y = 0; y < seaty; y++)
            {
                ...
                for (int x = 0; x < seatx; x++)
                {
                    ...
                    seatinfo += "<div id='divseat" + seatstr + "' class='mt_sli sblock' onclick=\"selectseat('" + seatstr + "')\" style=\"width:" + iwidth + "px;height:" + iheight + "px;line-height:" + iheight + "px;\"></div>\r\n";
                }
